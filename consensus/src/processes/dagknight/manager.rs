...
use kaspa_consensus_core::{
    blockhash::BlockHashExtensions, BlockHashMap, BlockHashSet, BlueWorkType, HashKTypeMap, HashMapCustomHasher, KType,
};
...
> {
    ...
    relations_store: RelationsStoreInFutureOfRoot<Q, MTReachabilityService<R>>,
