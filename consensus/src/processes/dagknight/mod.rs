...
impl DagknightCountersSnapshot {
    ...
    pub fn checkpoint_hit_rate(&self) -> f64 {
        ...
        if total == 0 {
            ...
            self.checkpoint_from_checkpoint as f64 / total as f64 * 100.0
        }
    }
...
impl std::ops::Sub for &DagknightCountersSnapshot {
    ...
    fn sub(self, rhs: &DagknightCountersSnapshot) -> Self::Output {
        DagknightCountersSnapshot {
            ...
            checkpoint_estimated_effort_saved: self.checkpoint_estimated_effort_saved.saturating_sub(rhs.checkpoint_estimated_effort_saved),
            checkpoint_estimated_effort_total: self.checkpoint_estimated_effort_total.saturating_sub(rhs.checkpoint_estimated_effort_total),
        }
    }
}
