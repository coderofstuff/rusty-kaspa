...
mod tests {
    ...
    fn test_rule_end_to_end_flow() {
        ...
        let mut good_snapshot = ProcessingCountersSnapshot::default();
        good_snapshot.blocks_submitted = 100;
        good_snapshot.header_counts = 100;
        good_snapshot.body_counts = 100;

        let mut bad_snapshot = ProcessingCountersSnapshot::default();
        bad_snapshot.blocks_submitted = 0;
        bad_snapshot.header_counts = 0;
        bad_snapshot.body_counts = 0;
